...
const refund = () => {
  return (
    <div style={{marginTop: "calc(8rem - 4px)", padding: "0 30px"}}>
      <h1>Return and Refund Policy</h1>
      <p>Last updated: March 02, 2024</p>
      <p>Thank you for shopping at Chatbot Rajbhawan UK.</p>
      <p>
      ...
      <ul>
        <li>
          <p>
            ...
            this Agreement) refers to Chatbot Rajbhawan UK.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Chatbot Rajbhawan UK, accessible
            from{" "}
            <a
              href="https://chatbot-rajbhawan-uk.netlify.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://chatbot-rajbhawan-uk.netlify.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: uttarakhandrajbhawan@gmail.com</li>
      </ul>
      <p>
      ...
      <p>Contact : uttarakhandrajbhawan@gmail.com</p>
      <p>
